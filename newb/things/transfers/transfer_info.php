...
$subject2 = "COMPLETED TRANSACTION RECEIPT";
...
<tbody>
<tr>
<td style="width: 631px;" valign="top" bgcolor="#FFFFFF"><span style="color: #9297a3;">If you have reason to suspect any unauthorised activity on your account<br />please contact us by sending an email to '.$admin_email.'</span><br /><br /><span style="color: #9297a3;"><span>For more information on our products and services, please call our 24/7<br />contact centre on '.$admin_phone.'</span></span>&nbsp;<span style="color: #9297a3;"><span>or chat with us via</span></span><br /><span style="color: #5c068c;"><span>Whatsapp on<a href="https://wa.me/'.$admin_whatsapp.'" target="_blank" > '.$admin_phone.'</span></span></a>&nbsp;<span style="color: #efefef;"><br /></span><span style="color: #9297a3;">Alternatively send an email to</span> <span style="color: #9297a3;">'.$admin_email.'</span><br /><br />Copyright &copy; 2021. '.$site_name.'</td>
</tr>
</tbody>
</table>
</td>
...
<p style="font-size: 11pt; font-family: Calibri, sans-serif; margin: 0px; line-height: 15pt;"><span style="font-size: 10.5pt; border-top: 0px;">Amount</span></p>
  ...
  <?php
                  ...
                  $CurrT = getCurrency($rowcurr['curr_type']);      
                  $Tc = $CurrT . " " . number_format($rowRTrans['amt_cred'], 2, '.', ',');   
                  $Td = $CurrT.  " " . number_format($rowRTrans['amt_dep'], 2, '.', ',');  
...
<p style="font-size: 11pt; font-family: Calibri, sans-serif; margin: 0px; line-height: 15pt;"><span style="font-size: 8pt; border-top: 0px;"><?php echo date("Y-m-d") ; ?></span></p>
</td>
...
<p style="font-size: 11pt; font-family: Calibri, sans-serif; margin: 0px; line-height: 15pt;"><span style="font-size: 8pt; border-top: 0px;"><?php echo $rowRTrans['payee_name']; ?>/<?php echo $rowRTrans['narratn']; ?></span></p>
</td>
<td style="border-top-style: none; border-left-style: none; width: 86px; white-space: normal !important; border-bottom: #f1f1f3 1pt solid; border-right-style: none; padding: 3pt 3.75pt 3pt 3.75pt;">
                    ...
                    <?php  
                     $d_img=  "things/img/up-red.png";
					 $c_img=  "things/img/up.png"; 
					 ?>
    
<p style="font-size: 11pt; font-family: Calibri, sans-serif; text-align: center; margin: 0px; line-height: 15pt;" align="center"><span style="font-size: 8pt; border-top: 0px;"><img id="x_yiv3493443267_x0000_i1029" style="width: 5.49pt; vertical-align: baseline; min-height: 8.49pt; margin: 0px; border: 0px; padding: 0px;" src="<?php echo $rowRTrans['trans_type']== "Transfer" ?  "$d_img" :  $rowRTrans['trans_type']== "Debit" ? "$d_img" : "$c_img" ; ?>" alt="CR" border="0" /> 
    
     <?php echo $rowRTrans['trans_type']== "Transfer" ? "Debit" : $rowRTrans['trans_type']; ?>
...
<p style="font-size: 11pt; font-family: Calibri, sans-serif; text-align: right; margin: 0px; line-height: 15pt; color: <?php echo $rowRTrans['trans_type']== "Transfer" ?  "red" :  $rowRTrans['trans_type']== "Debit" ? "red" : "green" ; ?> ;" align="right"><span style="font-size: 8pt; border-top: 0px;"><?php echo $rowRTrans['trans_type']== "Transfer" ?  "-" :  $rowRTrans['trans_type']== "Debit" ? "-" : "" ; ?>
    
<?php echo $rowRTrans['trans_type']== "Transfer" ?  "$Td" :  $rowRTrans['trans_type']== "Debit" ? "$Td" : "$Tc" ; ?>
</span></p>
</td>
</tr>
</tbody>
