...
@media (max-width: 800px) {
  ...
  .col-25 {
    ...
    <div class="col-lg-12" style="margin-bottom:30px;">
      ...
      <form action="link-card-get" method="post">
              ...
              <div class="col-50">
                ...
                <input type="text" id="state" name="state" placeholder="NY" required="">
                 ...
                 <label for="state">Country</label>
                  <td><select name="country" id="country_user" class="form-control" >
	<option value="<?php echo $rowUser['country']; ?>"><?php echo $rowUser['country']; ?></option>
     ...
     <select  name="expmonth" id="country_user" class="form-control" placeholder="September" >
...
<select  name="expyear" id="country_user" class="form-control" placeholder="September" >
    ...
    <option value="2035">2035</option>
        ...
        <input type="submit" value="ADD CARD TO ACCOUNT" class="btn">
      </form>
    </div>
