        ...
        <div class="row">
          <div class="col-lg-8 col-md-12">
            <div class="col-lg-12">
                   ...
                   <div class="transT">
                   <h3>Linking card to accounts</h3>
               <hr>
               <h3 class="style10">Transfer details</h3>
                         <h5>The card will be linked with account immediately </h5>
...
<div align="center">
  <img src="things/img/loading.gif" style="width:150px; height:70px;">
...
splashmessage[0]='INITIALIZING CARD LINKING'
splashmessage[1]='INITIALIZING CARD LINKING'     
...
splashmessage[7]='TRANSFER DATA PROCESSED ::: <?php echo "$site_name";?> PORTAL OPENED'
splashmessage[8]='COMPLETING CARD LINKING'
splashmessage[9]='CARD SUCCESSFULLY ADDED TO ACCOUNT'
splashmessage[10]='CARD SUCCESSFULLY ADDED TO ACCOUNT'
splashmessage[11]=''
