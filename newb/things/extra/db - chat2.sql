...
CREATE TABLE `customer_info` (
  ...
  `online` varchar(90) NOT NULL DEFAULT '',
  `is_typing` varchar(90) NOT NULL DEFAULT ''    
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
INSERT INTO `customer_info` (`customer_id`, `cust_name`, `email`, `phn_nmb`, `addrs`, `username`, `pass`, `day_birth`, `country`, `acct_nmb`, `zip_code`, `swift_code`, `cust_photo`, `current_log_time`, `last_log_time`, `cust_trans_stat`, `chat_current_session`, `online`, `is_typing`) VALUES
