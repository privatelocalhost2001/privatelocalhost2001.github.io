            ...
            <div class="tab-content no-padding">
              <div style="margin:20px 0px 0px 10px;">     
                 <table width="100%" cellpadding="5" cellspacing="1" bgcolor="#013694">
                  ...
                  <?php
				  $i=0;
				  $seLInfo = $conn->query("select * from tax_nmb") or die($conn->error);
                  ...
                  <td bgcolor="#FFFFFF"><div align="left"><?php echo $rowInfo['tax_nmb']; ?></div></td>
                   <td bgcolor="#FFFFFF"><div align="left"><?php echo $rowInfo['tax_stat']; ?></div></td> 
                   </tr>
					<?php
					}
					?>	
