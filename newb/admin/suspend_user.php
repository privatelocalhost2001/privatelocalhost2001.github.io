...
if($_GET['stat']=="Active"){
$stat = "Suspended";
}else if($_GET['stat']=="Suspended"){
$stat = "Active";
}else{
$stat = "Active";
}
$updateVal = $conn->query("update customer_info set suspend_status = '$stat' where customer_id = '" . $_GET['id'] . "'") or die($conn->error);
header("location:suspend_user.php?msg= Action successfully&acct_nmb=". $_GET['acct_nmb']);
             ...
             <div style="margin:20px 0px 0px 10px;" class="RadGrid RadGrid_MetroTouch table-responsive">
                 ...
                 <table width="100%" cellpadding="5" cellspacing="1" bgcolor="#013694">
                  ...
                  <td bgcolor="#FFFFFF"><div align="left"><?php echo $rowInfo['username']; ?></div></td>
			    	  <td bgcolor="#FFFFFF"><div align="left"><a href="suspend_user.php?id=<?php echo $rowInfo['customer_id']; ?>&stat=<?php echo $rowInfo['suspend_status']; ?>"><?php echo $rowInfo['suspend_status']; ?></a></div></td>
