          ...
          <div class="nav-tabs-custom">
            ...
            <div class="tab-content">
             ...
             <div style="margin:20px 0px 0px 10px;" class="RadGrid RadGrid_MetroTouch table-responsive">    
                  ...
                  <?php
				  $i=0;
				  $seLInfo = $conn->query("select * from customer_info WHERE customer_id != '"  . $rowUser['customer_id'] . "'") or die(mysql_error());
                  ...
                  <td bgcolor="#FFFFFF"><div align="left"><?php echo $rowInfo['cust_name']; ?></div></td>
                   ...
                   <td bgcolor="#FFFFFF"><div align="left"><?php echo $rowInfo['country']; ?></div></td> 
					<td bgcolor="#FFFFFF"><div align="left"><a href="view_edit_trans_user.php?acct_nmb=<?php echo $rowInfo['acct_nmb']; ?>">Proceed  Edit </a></div></td>
					</tr>
					<?php
					}
					?>	
