        ...
        <section class="col-lg-12 connectedSortable">
          ...
          <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs pull-right">
              ...
              <li class="pull-left header"><i class="fa fa-inbox"></i> Tax Code</li>
            </ul>
            <div class="tab-content no-padding">
              <div style="margin:20px 0px 0px 10px;">     
                 <table width="100%" cellpadding="5" cellspacing="1" bgcolor="#013694">
                  ...
                  <?php
				  $i=0;
				  $seLInfo = $conn->query("select * from cot_nmb") or die($conn->error);
                  ...
                  <td bgcolor="#FFFFFF"><div align="left"><?php echo $rowInfo['cot_nmb']; ?></div></td>
                   <td bgcolor="#FFFFFF"><div align="left"><?php echo $rowInfo['cot_status']; ?></div></td> 
                   </tr>
					<?php
					}
					?>	
