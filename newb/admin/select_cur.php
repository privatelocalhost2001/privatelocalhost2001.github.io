...
header("location:currency.php?msg=Currency has been changed");
}
          ...
          <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs pull-right">
              ...
              <li><a href="#sales-chart" data-toggle="tab">Donut</a></li>
                ...
                $selCuInfo = $conn->query("select * from customer_info where acct_nmb = '" . $_GET['id'] . "'") or die($conn->error);
                $rowCuInfo = $selCuInfo->fetch_array()
                ?>
              <li class="pull-left header"><i class="fa fa-inbox"></i> Select Currency For <?php echo $rowCuInfo['cust_name']; ?></li>
            </ul>
            <div class="tab-content no-padding">
			  ...
			  ?>
              <div style="margin:20px 0px 0px 10px;" class="col-lg-6">     
                          <form method="post" action="select_cur.php" enctype="multipart/form-data">   
                                    
                                    <table width="100%" align="center" cellpadding="5" cellspacing="3">
                  <tr>
                  <td height="46"><span class="style1">Currency type</span></td>
                  <td>
                  <input type="hidden" name="accnt_nmb" value="<?php echo $_GET['id']; ?>"/> 
                  <select name="cur_type" id="cur_type" class="form-control">
                  ...
                  <tr>
                  <td height="60" colspan="2">	<button  aria-label="Next" type="submit" name="action" value="create currency" class="btn btn-info col-lg-12">Enter</button></td>
                  </tr>
