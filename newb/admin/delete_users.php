...
header("location:delete_users.php?msg=User has been successfully deleted&id=". $_GET['id']);
}
                 ...
                 <table width="100%" cellpadding="5" cellspacing="1" bgcolor="#013694">
                  ...
                  <th bgcolor="#007EB6"><div align="left" class="style10 style1">Account</div></th>
                   ...
                   <th bgcolor="#007EB6"><div align="left" class="style10 style1">Phone Number</div></th>
                    <th bgcolor="#007EB6"><div align="left" class="style10 style1">Delete User</div></th>
                  ...
                  <td bgcolor="#FFFFFF"><div align="left"><a href="delete_users.php?action=delte user&id=<?php echo $rowInfo['customer_id']; ?>"> Delete Account </a></div></td>
					</tr>
					<?php
					}
					?>	
