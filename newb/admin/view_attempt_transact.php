...
header("location:view_attempt_transact.php?msg=Reminder message has been sent successfully&acct_nmb=". $_GET['acct_nmb']);
          ...
          <div class="nav-tabs-custom">
            ...
            <div style="margin:20px 0px 0px 10px;" class="RadGrid RadGrid_MetroTouch table-responsive">
                 ...
                 <table width="100%" cellpadding="5" cellspacing="1" bgcolor="#013694">
                  ...
                  <?php
				  $i=0;
				  $seLTransInfo = $conn->query("select * from transfer_info ORDER BY date_trans DESC") or die($conn->error);
				 ...
				 ?>  
                  ...
                  <td height="35" bgcolor="#FFFFFF"><div align="left"><?php echo $i; ?></div></td>
                    ...
                    <td bgcolor="#FFFFFF"><div align="left"><?php echo $rowTInfo['trans_stat']; ?></div></td>
                      
                      
                    <td bgcolor="#FFFFFF"><div align="left"><a href="view_attempt_transact.php?Tid=<?php echo $rowTInfo['trans_id']; ?>&action1=SELECT transaction&acct_nmb=<?php echo $rowTInfo['acct_nmb']; ?>">REMIND</a></div></td>
