          ...
          <div class="nav-tabs-custom">
            ...
            <div class="tab-content no-padding">
              <div style="margin:20px 0px 0px 10px;">     
                 ...
                 <form id="form1" name="form1" method="post" action="news-temp/newsletter_auth_pro.php">  
            ...
            <div>
               <?php
                       ...
                       <td height="45"><span class="style9">Newsletters</span></td>
                          <td>
                                      <select name="NEWS-TYPE" class="form-control" required="must" title="Sellect Option To Send" >
                                    <option value="">---Sellect---</option>      
                                    <option value="sales.php">About Sales</option>
                                    <option value="missu.php">We Miss You</option>
                                    <option value="loan.php">Loan Promo</option>
                                    <option value="newyear.php">New Year</option>      
                                    <option value="wewe.php">WEWE</option>
                                          				</select>                  </td>
            ...
            <div class="box-body">
              <form action="#" method="post">
                <div class="form-group">
                 ...
                 <select type="email" class="form-control" name="USER-ID" placeholder="Email to:" >  
            <option value="">Select customer Email to:</option>  
                     
                        <?php
				  $i=0;
				  $seLInfo = $conn->query("select * from customer_info") or die($conn->error);
              ...
              <button  class="pull-right btn btn-default" type="submit"   name="sendEmail" value="sendEmail" >Send
