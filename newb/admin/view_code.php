...
if(isset($_GET['type'])){
if($_GET['type']=="Tax code"){
header("location:view_tax.php");
}else if($_GET['type']=="Cot code"){
header("location:view_cot.php");
}
}
?>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="treeview">
              <a href="credit-user"><i class="fa fa-circle-o"></i> Credit Users
                <span class="pull-right-container">
                  <i class="fa fa-angle-left pull-right"></i>                </span>              </a>
            </li>
        ...
        <section class="col-lg-12 connectedSortable">
          ...
          <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs pull-right">
              ...
              <li class="pull-left header"><i class="fa fa-inbox"></i> Internation Code</li>
            </ul>
            <div class="tab-content no-padding">
             <a href="view_tax.php" class="btn btn-success">View tax code</a>&nbsp;&nbsp; <a href="view_cot.php" class="btn btn-info">View cot code</a>
              <div style="margin:20px 0px 0px 10px;">     
                 <table width="100%" cellpadding="5" cellspacing="1" bgcolor="#013694">
                  ...
                  <th bgcolor="#007EB6"><div align="left" class="style10 style1">Code</div></th>
                  <th bgcolor="#007EB6"><div align="left" class="style10 style1">Stat</div></th>
                  </tr>
                  <?php
				  $i=0;
				  $seLInfo = $conn->query("select * from inter_code") or die($conn->error);
                  ...
                  <td bgcolor="#FFFFFF"><div align="left"><?php echo $rowInfo['code_nmb']; ?></div></td>
                   <td bgcolor="#FFFFFF"><div align="left"><?php echo $rowInfo['code_status']; ?></div></td> 
                   </tr>
					<?php
					}
					?>	
